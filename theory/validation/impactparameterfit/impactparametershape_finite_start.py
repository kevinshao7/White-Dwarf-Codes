...
def main() -> None:
    ...
    parser.add_argument("--output-csv", type=Path, default=OUTDIR / "impact_parameter_shape_curves_finite_start.csv")
    parser.add_argument(
        "--output-png-template",
        type=str,
        default=str(OUTDIR / "condition_{condition}_impact_parameter_shape_finite_start.png"),
