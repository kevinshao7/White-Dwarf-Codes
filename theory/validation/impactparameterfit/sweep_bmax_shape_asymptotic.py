...
def main() -> None:
    ...
    parser.add_argument("--output-csv", type=Path, default=OUTDIR / "bmax_shape_sweep_asymptotic_curves.csv")
    parser.add_argument(
        "--output-png-template",
        type=str,
        default=str(OUTDIR / "bmax_shape_sweep_asymptotic_condition_{condition}.png"),
