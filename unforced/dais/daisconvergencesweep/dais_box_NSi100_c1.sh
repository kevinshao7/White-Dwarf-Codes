...
#SBATCH --job-name=dais_box_NSi100_c1
...
#SBATCH --output=dais_box_NSi100_c1_%j.out
#SBATCH --error=dais_box_NSi100_c1_%j.err
...
INPUT=dais_box_NSi100_c1.in
LMP_LOG="dais_box_NSi100_c1_${SLURM_JOB_ID}.lammps.log"
