...
#SBATCH --job-name=dais_cutoff_1lS_c0
...
#SBATCH --output=dais_cutoff_1lS_c0_%j.out
#SBATCH --error=dais_cutoff_1lS_c0_%j.err
...
INPUT=dais_cutoff_1lS_c0.in
LMP_LOG="dais_cutoff_1lS_c0_${SLURM_JOB_ID}.lammps.log"
