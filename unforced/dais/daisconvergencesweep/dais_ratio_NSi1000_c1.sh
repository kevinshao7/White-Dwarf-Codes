...
#SBATCH --job-name=dais_ratio_NSi1000_c1
...
#SBATCH --error=dais_ratio_NSi1000_c1_%j.err
...
INPUT=dais_ratio_NSi1000_c1.in
LMP_LOG="dais_ratio_NSi1000_c1_${SLURM_JOB_ID}.lammps.log"
