...
#SBATCH --job-name=dais_ratio_NSi100_c0
...
#SBATCH --output=dais_ratio_NSi100_c0_%j.out
#SBATCH --error=dais_ratio_NSi100_c0_%j.err
...
INPUT=dais_ratio_NSi100_c0.in
LMP_LOG="dais_ratio_NSi100_c0_${SLURM_JOB_ID}.lammps.log"
