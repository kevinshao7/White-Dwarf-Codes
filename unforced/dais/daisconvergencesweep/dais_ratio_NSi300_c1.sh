...
#SBATCH --job-name=dais_ratio_NSi300_c1
...
#SBATCH --output=dais_ratio_NSi300_c1_%j.out
#SBATCH --error=dais_ratio_NSi300_c1_%j.err
...
INPUT=dais_ratio_NSi300_c1.in
LMP_LOG="dais_ratio_NSi300_c1_${SLURM_JOB_ID}.lammps.log"
