...
#SBATCH --job-name=unforcedvel_v5.4e+05_c0
...
#SBATCH --output=unforcedvel_v5.4e+05_c0_%j.out
#SBATCH --error=unforcedvel_v5.4e+05_c0_%j.err
...
INPUT=unforcedvel_v5.4e+05_c0.in
LMP_LOG="unforcedvel_v5.4e+05_c0_${SLURM_JOB_ID}.lammps.log"
