...
#SBATCH --job-name=unforcedvel_v9.0e+06_c2
...
#SBATCH --output=unforcedvel_v9.0e+06_c2_%j.out
#SBATCH --error=unforcedvel_v9.0e+06_c2_%j.err
...
INPUT=unforcedvel_v9.0e+06_c2.in
LMP_LOG="unforcedvel_v9.0e+06_c2_${SLURM_JOB_ID}.lammps.log"
