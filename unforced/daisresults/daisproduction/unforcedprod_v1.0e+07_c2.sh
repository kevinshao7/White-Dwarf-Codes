...
#SBATCH --job-name=unforcedprod_v1.0e+07_c2
...
#SBATCH --output=unforcedprod_v1.0e+07_c2_%j.out
#SBATCH --error=unforcedprod_v1.0e+07_c2_%j.err
...
INPUT=unforcedprod_v1.0e+07_c2.in
LMP_LOG="unforcedprod_v1.0e+07_c2_${SLURM_JOB_ID}.lammps.log"
