...
#SBATCH --job-name=unforcedprod_v2.2e+07_c2
...
#SBATCH --output=unforcedprod_v2.2e+07_c2_%j.out
#SBATCH --error=unforcedprod_v2.2e+07_c2_%j.err
...
INPUT=unforcedprod_v2.2e+07_c2.in
LMP_LOG="unforcedprod_v2.2e+07_c2_${SLURM_JOB_ID}.lammps.log"
