...
#SBATCH --job-name=dais_box_NSi3000_c0
...
#SBATCH --output=dais_box_NSi3000_c0_%j.out
#SBATCH --error=dais_box_NSi3000_c0_%j.err
...
INPUT=dais_box_NSi3000_c0.in
LMP_LOG="dais_box_NSi3000_c0_${SLURM_JOB_ID}.lammps.log"
