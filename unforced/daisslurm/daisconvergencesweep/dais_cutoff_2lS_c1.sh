...
#SBATCH --job-name=dais_cutoff_2lS_c1
...
#SBATCH --output=dais_cutoff_2lS_c1_%j.out
#SBATCH --error=dais_cutoff_2lS_c1_%j.err
...
INPUT=dais_cutoff_2lS_c1.in
LMP_LOG="dais_cutoff_2lS_c1_${SLURM_JOB_ID}.lammps.log"
