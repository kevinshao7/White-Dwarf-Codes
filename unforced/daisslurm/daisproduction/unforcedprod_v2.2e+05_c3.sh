...
#SBATCH --job-name=unforcedprod_v2.2e+05_c3
...
#SBATCH --output=unforcedprod_v2.2e+05_c3_%j.out
#SBATCH --error=unforcedprod_v2.2e+05_c3_%j.err
...
INPUT=unforcedprod_v2.2e+05_c3.in
LMP_LOG="unforcedprod_v2.2e+05_c3_${SLURM_JOB_ID}.lammps.log"
