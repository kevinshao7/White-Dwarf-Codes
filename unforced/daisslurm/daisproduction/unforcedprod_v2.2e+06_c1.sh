...
#SBATCH --job-name=unforcedprod_v2.2e+06_c1
...
#SBATCH --output=unforcedprod_v2.2e+06_c1_%j.out
#SBATCH --error=unforcedprod_v2.2e+06_c1_%j.err
...
INPUT=unforcedprod_v2.2e+06_c1.in
LMP_LOG="unforcedprod_v2.2e+06_c1_${SLURM_JOB_ID}.lammps.log"
