...
#SBATCH --job-name=unforcedprod_v4.6e+06_c0
...
#SBATCH --output=unforcedprod_v4.6e+06_c0_%j.out
#SBATCH --error=unforcedprod_v4.6e+06_c0_%j.err
...
INPUT=unforcedprod_v4.6e+06_c0.in
LMP_LOG="unforcedprod_v4.6e+06_c0_${SLURM_JOB_ID}.lammps.log"
