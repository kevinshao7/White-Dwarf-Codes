...
#SBATCH --job-name=unforcedprod_v4.6e+07_c1
...
#SBATCH --output=unforcedprod_v4.6e+07_c1_%j.out
#SBATCH --error=unforcedprod_v4.6e+07_c1_%j.err
...
INPUT=unforcedprod_v4.6e+07_c1.in
LMP_LOG="unforcedprod_v4.6e+07_c1_${SLURM_JOB_ID}.lammps.log"
